<script setup>
document.title = '智能阅卷系统 - 题目管理 - 修改题目'
import { ref } from 'vue'
...
<template>
  <div class="cz">
    <tiny-breadcrumb>
      ...
      <tiny-breadcrumb-item :to="{ path: '/updatequestion' }" label="修改题目"></tiny-breadcrumb-item>
    </tiny-breadcrumb>
    <tiny-form>
      ...
      <tiny-form-item>
        <tiny-button type="info" @click="updateQuestion">修改</tiny-button>
      </tiny-form-item>
    </tiny-form>
  </div>
</template>