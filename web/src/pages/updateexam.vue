<script setup>
document.title = '智能阅卷系统 - 考试管理 - 修改考试'
import { ref } from 'vue'
...
<template>
  <div class="cz">
    <tiny-breadcrumb>
      ...
      <tiny-breadcrumb-item :to="{ path: '/updateexam' }" label="修改考试"></tiny-breadcrumb-item>
    </tiny-breadcrumb>
    <tiny-form>
      ...
      <tiny-form-item>
        <tiny-button type="info" @click="updateExam">修改</tiny-button>
      </tiny-form-item>
    </tiny-form>
  </div>
</template>