      ...
      <div class="cz">
        <div class="spacebetween">
          ...
          <div class="sp">
            ...
            <div><tiny-button type="info" @click="scorereportconfig(item.examId, '多学科')">多学科成绩报告配置</tiny-button></div>
            <div><tiny-button type="info" @click="updateExam(item)">修改</tiny-button></div>
